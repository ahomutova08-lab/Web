...
<head>
  ...
  <meta property="og:title"       content="Pește la grătar – Rețele culinare">
  <meta property="og:description" content="Pește la grătar, gustos și sănătos. ⏱ 25 min · 📈 ușor · <?= $summary['count'] ?> recenzii.">
  <meta property="og:image"       content="https://media.istockphoto.com/id/1397370987/photo/grilled-mackerel-fish-with-the-addition-of-herbs-and-lemon-slices-on-the-grill.webp?a=1&b=1&s=612x612&w=0&k=20&c=7Bf3kN9XuIz8IWmNKBB9rIWw_ls74jzJX3Zc4pwF61w=">
  <meta property="og:type"        content="article">

  <title>Pește la grătar - Rețele culinare</title>
  ...
  <main class="container">
    <article class="recipe">
      ...
      <div class="recipe-meta">
        ...
        <button id="page-fav-btn" class="page-fav-btn" type="button" data-recipe="retete/peste-gratar.php">
      ...
      <div class="recipe-hero">
        <div>
          <p>Peștele la grătar este un preparat gustos și ușor, perfect pentru un prânz sau o cină sănătoasă.</p>
        ...
        <div>
          <img
            src="https://media.istockphoto.com/id/1397370987/photo/grilled-mackerel-fish-with-the-addition-of-herbs-and-lemon-slices-on-the-grill.webp?a=1&b=1&s=612x612&w=0&k=20&c=7Bf3kN9XuIz8IWmNKBB9rIWw_ls74jzJX3Zc4pwF61w="
            alt="Pește la grătar"
            class="recipe-img"
            width="612"
            loading="lazy"
      ...
      <div class="recipe-grid">
        ...
        <section class="card">
          ...
          <ul id="ingredient-list">
            <li data-base="400"><span class="qty">400</span> g file de pește</li>
        ...
        <section class="card">
          <h2>📝 Instrucțiuni</h2>
          <ol class="steps">
            <li>Peștele se condimentează.</li>
            <li>Se stropește cu suc de lămâie.</li>
            <li>Se unge cu ulei.</li>
            <li>Se gătește pe grătar 5–7 minute pe fiecare parte.</li>
          </ol>
        </section>
      ...
      <section class="card">
        <h2>💡 Sfaturi</h2>
        <p>Nu întoarce peștele prea des pentru a evita ruperea fileului.</p>
      </section>
